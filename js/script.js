...
function auditorio(){
    ...
    //Quantidades de lugares no total que o auditório laranja tem (contando os 70 lugasres adicionais)
...
function reservaRestaurante(){
    //Primeiro uso de um obejeto com atribuição de valores.

    /*Cada valor na chave representa um dia da semana e 
    dentro das chaves atribuidos a else, temos a hora de início e término; */
...
function abastecer_carros() {
    ...
    let alcool_wayneOil = parseFloat(prompt('Qual o valor do álcool no posto Wayne Oil?'));
    let gasolina_wayneOil = parseFloat(prompt('Qual o valor da gasolina no posto Wayne Oil?'));
    let alcool_starkPetrol = parseFloat(prompt('Qual o valor do álcool no posto Stark Petrol?'));
    let gasolina_starkPetrol = parseFloat(prompt('Qual o valor da gasolina no posto Stark Petrol?'));

    // 0.7 seria a diferença de 30% do valor do alcool em relação a gasolina
    if(alcool_wayneOil < 0.7 * gasolina_wayneOil && alcool_wayneOil < alcool_starkPetrol){
        alert('É mais barato abastecer com o alcool no posto WayneOil');
        inicio();

    }else if(gasolina_wayneOil < gasolina_starkPetrol){
        alert('É mais barato abastecer com a gasolina no posto WayneOil');
        inicio();
    
    }else if(alcool_starkPetrol < 0.7 * gasolina_starkPetrol){
        alert('É mais barato abastecer com o alcool da stark petrol');
        inicio();

    }else{
        alert('É mais barato abastecer com a gasolina da stark petrol');
        inicio();
    }
}
